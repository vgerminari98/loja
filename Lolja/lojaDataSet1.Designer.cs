...
namespace Lolja {
    ...
    public partial class lojaDataSet1 : global::System.Data.DataSet {
        ...
        public partial class categoriasDataTable : global::System.Data.TypedTableBase<categoriasRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public categoriasRow AddcategoriasRow(string desc_categoria, bool estado) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public categoriasRow FindBycodigo_categoria(int codigo_categoria) {
        ...
        public partial class categoriasRow : global::System.Data.DataRow {
            ...
            public int codigo_categoria {
                get {
                    return ((int)(this[this.tablecategorias.codigo_categoriaColumn]));
                }
                set {
            ...
            public string desc_categoria {
                get {
                    return ((string)(this[this.tablecategorias.desc_categoriaColumn]));
                }
                set {
                    this[this.tablecategorias.desc_categoriaColumn] = value;
                }
            }
...
namespace Lolja.lojaDataSet1TableAdapters {
    ...
    public partial class categoriasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `categorias` WHERE ((`codigo_categoria` = @Original_codigo_categoria)" +
                " AND (`desc_categoria` = @Original_desc_categoria) AND (`estado` = @Original_est" +
                "ado))";
            ...
            param.ParameterName = "@Original_desc_categoria";
            param.DbType = global::System.Data.DbType.String;
            param.MySqlDbType = global::MySql.Data.MySqlClient.MySqlDbType.VarChar;
            param.IsNullable = true;
            param.SourceColumn = "desc_categoria";
            param.SourceVersion = global::System.Data.DataRowVersion.Original;
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::MySql.Data.MySqlClient.MySqlParameter();
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `categorias` (`desc_categoria`, `estado`) VALUES (@desc_categoria, @e" +
                "stado)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            param = new global::MySql.Data.MySqlClient.MySqlParameter();
            param.ParameterName = "@desc_categoria";
            param.DbType = global::System.Data.DbType.String;
            param.MySqlDbType = global::MySql.Data.MySqlClient.MySqlDbType.VarChar;
            param.IsNullable = true;
            param.SourceColumn = "desc_categoria";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `categorias` SET `desc_categoria` = @desc_categoria, `estado` = @estado WH" +
                "ERE ((`codigo_categoria` = @Original_codigo_categoria) AND (`desc_categoria` = @" +
                "Original_desc_categoria) AND (`estado` = @Original_estado))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `codigo_categoria`, `desc_categoria`, `estado` FROM `categorias`";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT `codigo_categoria`, `desc_categoria`, `estado` FROM `categorias`\r\nwhere es" +
                "tado=1";
        ...
        public virtual int Fill(lojaDataSet1.categoriasDataTable dataTable) {
        ...
        public virtual lojaDataSet1.categoriasDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            lojaDataSet1.categoriasDataTable dataTable = new lojaDataSet1.categoriasDataTable();
        ...
        public virtual int FillBy(lojaDataSet1.categoriasDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(lojaDataSet1.categoriasDataTable dataTable) {
        ...
        public virtual int Delete(int Original_codigo_categoria, string Original_desc_categoria, byte Original_estado) {
        ...
        public virtual int Insert(string desc_categoria, byte estado) {
        ...
        public virtual int Update(string desc_categoria, byte estado, int Original_codigo_categoria, string Original_desc_categoria, byte Original_estado) {
            if ((desc_categoria == null)) {
                throw new global::System.ArgumentNullException("desc_categoria");
            }
            else {
