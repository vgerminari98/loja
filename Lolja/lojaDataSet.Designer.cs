...
namespace Lolja {
    ...
    public partial class lojaDataSet : global::System.Data.DataSet {
        ...
        public partial class categoriasDataTable : global::System.Data.TypedTableBase<categoriasRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public categoriasRow AddcategoriasRow(string desc_categoria) {
...
namespace Lolja.lojaDataSetTableAdapters {
    ...
    public partial class categoriasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `categorias` WHERE ((`codigo_categoria` = @Original_codigo_categoria)" +
                " AND (`desc_categoria` = @Original_desc_categoria))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `categorias` (`desc_categoria`) VALUES (@desc_categoria)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `categorias` SET `desc_categoria` = @desc_categoria WHERE ((`codigo_catego" +
                "ria` = @Original_codigo_categoria) AND (`desc_categoria` = @Original_desc_catego" +
                "ria))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `codigo_categoria`, `desc_categoria` FROM `categorias`";
        ...
        public virtual int Fill(lojaDataSet.categoriasDataTable dataTable) {
        ...
        public virtual lojaDataSet.categoriasDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            lojaDataSet.categoriasDataTable dataTable = new lojaDataSet.categoriasDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(lojaDataSet.categoriasDataTable dataTable) {
        ...
        public virtual int Delete(int Original_codigo_categoria, string Original_desc_categoria) {
        ...
        public virtual int Update(string desc_categoria, int Original_codigo_categoria, string Original_desc_categoria) {
            if ((desc_categoria == null)) {
                throw new global::System.ArgumentNullException("desc_categoria");
            }
            else {
